...
const tables = (translate, datas, handleActions) => ({
  ...
  contents: datas.map(({
    ...
    id: {
      type: PROPERTY,
      className: deleted_at ? 'play-table-content-row__td-gray' : '',
      value: id,
      shortened: true,
    },
    key: {
    ...
    active: {
      type: PROPERTY,
      className: deleted_at ? 'play-table-content-row__td-red' : 'play-table-content-row__td-green',
      value: deleted_at ? <FA name="times" /> : <FA name="check" />,
      shortened: false,
    },
    action: {
      type: ACTIONS,
      className: deleted_at ? 'play-table-content-row__td-gray' : 'play-table-content-row__td-red',
      value: [{
