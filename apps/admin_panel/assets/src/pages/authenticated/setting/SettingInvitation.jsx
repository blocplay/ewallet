...
import PLAYAddMemberForm from '../../../components/PLAYAddMemberForm';
import PLAYMemberItem from '../../../components/PLAYMemberItem';
...
class SettingInvitation extends Component {
  ...
  handleSyncMember(targetMember, actionType) {
    const { add, update, remove } = PLAYAddMemberForm.actionType();
    const {
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        {memberItems}
        <div className="mt-3 play-hide">
          <h4>
            {translate('setting.form.remove_account.label')}
            <a className="play-member-item__edit" href="#remove">
