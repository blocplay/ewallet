...
const PLAYTableHeader = ({
  ...
  if (sortable) {
    return (
      <th className={`play-header-button ${alignment.className}`} onClick={() => handleClick(id, nextSort(sortDirection))}>
        {title}
...
PLAYTableHeader.defaultProps = {
  sortDirection: 'default',
};

PLAYTableHeader.propTypes = {
...
export default PLAYTableHeader;
