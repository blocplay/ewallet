...
import PLAYPager from '../components/PLAYPager';

const PLAYPaginatorFactory = (PaginatedComponent) => {
  class PLAYPaginatorHOC extends Component {
    constructor(props) {
      super(props);
      this.state = {
  ...
  PLAYPaginatorHOC.propTypes = {
    history: PropTypes.object.isRequired,
    loadData: PropTypes.func.isRequired,
    location: PropTypes.object.isRequired,
  };

  return PLAYPaginatorHOC;
};

export default PLAYPaginatorFactory;
