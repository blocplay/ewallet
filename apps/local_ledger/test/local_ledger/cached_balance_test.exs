defmodule LocalLedger.CachedBalanceTest do
  ...
  setup do
    ...
    minted_token_1 = insert(:minted_token, friendly_id: "PLAY:1234")
  ...
  describe "get/2" do
    test "calculates the balance and inserts a new cached balance if not existing",
      %{balance: balance}
    do
      {res, amounts} = CachedBalance.get(balance, "PLAY:1234")
      assert res == :ok
      assert amounts == %{"PLAY:1234" => 120_000 - 61_047}
