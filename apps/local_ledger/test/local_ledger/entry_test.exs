  ...
  describe "#insert" do
    ...
    def genesis do
      {:ok, entry} = Entry.insert(%{
        ...
        "debits" => debits(),
        "credits" => credits(),
        "minted_token" => %{"friendly_id" => "PLAY:209d3f5b-eab4-4906-9697-c482009fc865", "metadata" => %{}},
    ...
    def get_current_balance(address) do
      Transaction.calculate_current_amount(address, "PLAY:209d3f5b-eab4-4906-9697-c482009fc865")
    end
