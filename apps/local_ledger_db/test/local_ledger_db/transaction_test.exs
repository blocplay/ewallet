defmodule LocalLedgerDB.TransactionTest do
  ...
  describe "calculate_all_balances/2" do
    test "returns the correct balances for each token" do
      ...
      {:ok, play} = :minted_token |> build(friendly_id: "PLAY:209d3f5b-eab4-4906-9697-c482009fc865") |> Repo.insert
      ...
      transfer(balance, play, 100, Transaction.debit_type)
      transfer(balance, play, 300, Transaction.credit_type)
      transfer(balance, play, 500, Transaction.credit_type)
      ...
      assert balances == %{
        ...
        "PLAY:209d3f5b-eab4-4906-9697-c482009fc865" => 700}
    end
    ...
    test "returns the correct balance for the specified token" do
      ...
      balances = Transaction.calculate_all_balances(balance.address, %{
        friendly_id: "PLAY:209d3f5b-eab4-4906-9697-c482009fc865"
      })
      assert balances == %{"PLAY:209d3f5b-eab4-4906-9697-c482009fc865" => 300 + 500 - 100}
    end

    test "calculates all balances since specified date" do
      {:ok, balance} = :balance |> build |> Repo.insert
      {:ok, play} = :minted_token |> build(friendly_id: "PLAY:123") |> Repo.insert
      ...
      assert all_balances == %{"KNC:456" => 100, "PLAY:123" => 300 + 500 - 100}
      assert balances == %{"KNC:456" => 100, "PLAY:123" => 500}
    end
    ...
    test "calculates all balances up to the specified date" do
      ...
      assert all_balances == %{"KNC:456" => 100, "PLAY:123" => 300 + 500 - 100}
      assert balances == %{"PLAY:123" => 300 - 100}
    end
    ...
    test "calculates all balances between the specified 'since' date and 'upto' date" do
      ...
      transfer(balance, play, 300, Transaction.credit_type)
      transfer(balance, play, 500, Transaction.credit_type)
      transfer(balance, play, 100, Transaction.credit_type)
      transfer(balance, play, 1200, Transaction.credit_type)
      transfer(balance, play, 250, Transaction.credit_type)
      ...
      assert all_balances == %{"PLAY:123" => 300 + 500 + 100 + 1200 + 250}
      assert balances == %{"PLAY:123" => 100 + 1200}
    end
  end
