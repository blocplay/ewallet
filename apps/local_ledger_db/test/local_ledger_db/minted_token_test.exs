defmodule LocalLedgerDB.MintedTokenTest do
  ...
  describe "#get_or_insert" do
    test "inserts the minted_token when it does not exist yet" do
      ...
      {:ok, minted_token} = MintedToken.get_or_insert(%{"friendly_id" => "PLAY:209d3f5b-eab4-4906-9697-c482009fc865",
                                                        "metadata" => %{}})
    ...
    defp start_task(pid, callback) do
      {:ok, pid} = Task.start_link fn ->
        ...
        assert minted_token.friendly_id == "PLAY:209d3f5b-eab4-4906-9697-c482009fc865"
        send pid, :updated
      end
